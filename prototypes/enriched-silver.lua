...
data:extend({
  {
    ...
    {
      primary = {r = 0.621, g = 0.525, b = 0.743, a = 0.000},
  ...
  },
  {
  ...
  },	
	{
		...
		crafting_machine_tint =
		{
			primary = {r = 0.60, g = 0.20, b = 0.7, a = 0.6},
			secondary = {r = 1.0, g = 0.843, b = 0.0, a = 0.9}
		},
		subgroup = "raw-material",
		order = "w013[dirty-water-filtration-silver]"
	}
}
)
util.add_effect("kr-enriched-ores", { type = "unlock-recipe", recipe = "enriched-silver" })
util.add_effect("kr-enriched-ores", { type = "unlock-recipe", recipe = "enriched-silver-plate" })
util.add_effect("kr-enriched-ores", { type = "unlock-recipe", recipe = "dirty-water-filtration-silver" })
end
